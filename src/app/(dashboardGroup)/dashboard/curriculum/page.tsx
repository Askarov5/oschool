...
export default function CurriculumManager() {
  ...
  const [newCurriculum, setNewCurriculum] = useState<ICurriculum>({
    id: "",
    name: "",
    description: "",
    subjects: [],
  ...
  const [editingCurriculum, setEditingCurriculum] =
    useState<ICurriculum | null>(null);
  ...
  const handleAddCurriculum = () => {
    if (newCurriculum.name) {
      setCurricula([
        ...curricula,
        { ...newCurriculum, id: Date.now().toString() },
      ]);
      setNewCurriculum({
        id: "",
        name: "",
  ...
  const handleShareCurriculum = (id: string) => {
    setCurricula(
      curricula.map((c) => (c.id === id ? { ...c, shared: true } : c)),
    );
  };
            ...
            <div className="container mx-auto py-8">
              ...
              <Tabs defaultValue="my-curricula">
                <TabsList className="mb-4">
                  ...
                  <TabsTrigger value="shared-curricula">
                    Shared Curricula
                  </TabsTrigger>
                </TabsList>
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Add a new curriculum here. Click save when you're
                            done.
                          </DialogDescription>
                        </DialogHeader>
                        <form
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                {subjects.map((subject) => (
                                  ...
                                  >
                                    <Checkbox
                                      id={subject}
                                      checked={newCurriculum.subjects.includes(
                                        subject,
                                      )}
                        ...
                        <CardFooter className="flex justify-between">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button
                              variant="outline"
                              onClick={() =>
                                handleShareCurriculum(curriculum.id)
                              }
                            >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          A comprehensive curriculum for advanced math topics
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="mb-2">
              ...
              {selectedCurriculum && (
                <Dialog
                  ...
                  onOpenChange={() => setSelectedCurriculum(null)}
                >
                  <DialogContent className="max-w-4xl">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Progress
                          value={selectedCurriculum.progress}
                          className="mb-2"
                        />
                    ...
                    <DialogFooter>
                      ...
                      <Button
                        onClick={() => handleEditCurriculum(selectedCurriculum)}
                      >
                        Edit Curriculum
                      </Button>
                    </DialogFooter>
              ...
              {editingCurriculum && (
                <Dialog
                  ...
                  onOpenChange={() => setEditingCurriculum(null)}
                >
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Edit Curriculum</DialogTitle>
                      <DialogDescription>
                        Make changes to your curriculum here. Click save when
                        you're done.
                      </DialogDescription>
                    </DialogHeader>
                    <form
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            {subjects.map((subject) => (
                              ...
                              >
                                <Checkbox
                                  id={`edit-${subject}`}
                                  checked={editingCurriculum.subjects.includes(
                                    subject,
                                  )}
                                  onCheckedChange={(checked) => {
                                    if (checked) {
                                      ...
                                      setEditingCurriculum({
                                        ...editingCurriculum,
                                        subjects:
                                          editingCurriculum.subjects.filter(
                                            (s) => s !== subject,
                                          ),
                                      });
                                    }
                        ...
                        <div>
                          ...
                          <ScrollArea className="h-[200px] border rounded-md p-4">
                            {editingCurriculum.chapters.map(
                              (chapter, index) => (
                                <div
                                  key={chapter.id}
                                  className="flex items-center justify-between py-2"
                                >
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) => {
                                      ...
                                      updatedChapters[index].completed =
                                        checked as boolean;
                                      setEditingCurriculum({
                                        ...editingCurriculum,
                                        chapters: updatedChapters,
                    ...
                    <DialogFooter>
                      <Button onClick={handleUpdateCurriculum}>
                        Save changes
                      </Button>
                    </DialogFooter>
                  </DialogContent>
