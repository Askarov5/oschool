...
export default function CreateTest() {
  ...
  const [questionType, setQuestionType] =
    useState<TQuestionType>("multipleChoice");
      ...
      <Card className="mt-6 p-4">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Select
              onValueChange={(value) => setQuestionType(value as TQuestionType)}
            >
              ...
              >
                ...
                <div className="flex space-x-2">
                  ...
                  <Button
                    ...
                    disabled={question.id === test.questions.length}
                  >
                    <MoveDown />
                  </Button>
                  <Button
