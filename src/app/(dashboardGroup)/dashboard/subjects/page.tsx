    ...
    return (
        <div className="container p-4 flex flex-col gap-4">
            <div className="flex gap-1 justify-between py-2">
                ...
                <Button onClick={() => setIsSubjectDialogOpen(true)}>Add New Subject</Button>
            </div>

            <Table>
                <TableHeader>
                    <TableRow>
                        <TableHead className="px-4 py-2 text-left font-semibold">Grade</TableHead>
                        <TableHead className="px-4 py-2 text-left font-semibold">Subject</TableHead>
                        <TableHead className="px-4 py-2 text-left font-semibold">Description</TableHead>
                                    ...
                                    <div className="flex gap-1">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button onClick={() => handleEditSubject(subject)} variant="default" className="p-2 px-3">
                                                    <Pen />
                                                </Button>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button onClick={() => handleDeleteSubject(subject.id)} variant="destructive" className="p-2 px-3">
                                                    <Trash />
                                                </Button>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button onClick={() => handleViewChapters(subject)} variant='outline' className="p-2 px-3">
                                                    <LayoutList />
                                                </Button>
                                            </TooltipTrigger>
                                            <TooltipContent>
            ...
            <Dialog open={isSubjectDialogOpen} onOpenChange={setIsSubjectDialogOpen}>
                <DialogContent>
                    ...
                    <SubjectForm onSave={handleAddSubject} subject={selectedSubject} onClose={() => setIsSubjectDialogOpen(false)} />
                </DialogContent>
            </Dialog>
            ...
            <Dialog open={isChapterDialogOpen} onOpenChange={setIsChapterDialogOpen}>
                <DialogContent>
                    <DialogTitle>Manage Chapters for {selectedSubject?.title}</DialogTitle>
                    {selectedSubject && (
                        <ChapterManagement subjectId={selectedSubject.id} onClose={() => setIsChapterDialogOpen(false)} />
                    )}
                </DialogContent>
            </Dialog>
        </div>
