...
import { BookOpen, Calculator, Atom, Globe, Palette, Rocket, LucideProps } from "lucide-react"
import Link from "next/link"
import { ReactNode, ReactElement, RefAttributes, ForwardRefExoticComponent } from "react"

type TSubject = {
    title: string;
    description: string;
    icon: ReactNode | ReactElement | ForwardRefExoticComponent<Omit<LucideProps, 'ref'>> | RefAttributes<SVGSVGElement>;
    href: string
}
