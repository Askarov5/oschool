...
export const ChapterForm = ({ onSave, onClose, chapter }: ChapterFormProps) => {
    ...
    const [bookContent, setBookContent] = useState(chapter?.bookContent.content || "");
    ...
    const handleSubmit = () => {
        const newChapter: IChapter = {
            ...
            bookContent: { id: "book_id", title: "Book Content Title", content: bookContent },
            test: { id: "test_id", title: "Sample Test", grade: '', passRate: 80, level: '', subject: title, questions: [] },
        };
    ...
    return (
            <Card className="border-none shadow-none">
                ...
                <CardContent className=" flex flex-col gap-2 px-0">
                    ...
                    <Textarea placeholder="Book Content" value={bookContent} onChange={(e) => setBookContent(e.target.value)} />
                </CardContent>
