...
const videos: IVideo[] = [
  ...
  },
  {
    ...
    title: "Laws of Motion in Physics",
  },
];
...
const bookContents: IBookContent[] = [
  {
    id: "book1",
    title: "Computer Basics Chapter",
    content:
      "Learn about the basics of computers, including hardware and software.",
  },
  {
    id: "book2",
    title: "Arithmetic Chapter",
    content:
      "An introduction to arithmetic operations, fractions, and decimals.",
  },
  {
    id: "book3",
    title: "Plants and Ecosystems",
    content: "Study of plants, ecosystems, and their roles in the environment.",
  },
  {
    id: "book4",
    title: "World Continents",
    content:
      "Overview of continents, countries, and cultures across the globe.",
  },
  {
    id: "book5",
    title: "Forces and Motion",
    content:
      "Understanding forces, motion, and the basic principles of physics.",
  },
];
...
const questions: IQuestion[] = [
  {
    ...
    answer: "CPU",
    explanation:
      "The CPU is the primary component that processes instructions in a computer.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    questionText:
      "Name the process plants use to convert sunlight into energy.",
