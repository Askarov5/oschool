...
const subjectsData: ISubject[] = [
  {
    ...
    description:
      "An introduction to basic computer concepts, digital literacy, and programming.",
    grade: 5,
  ...
  },
  {
    ...
    description:
      "Core math concepts, including arithmetic, fractions, and basic geometry.",
    grade: 5,
  ...
  },
  {
    ...
    description:
      "An introduction to plant and animal biology, ecosystems, and cells.",
    grade: 6,
  ...
  },
  {
    ...
    description:
      "World geography, continents, oceans, and environmental studies.",
    grade: 6,
  ...
  },
  {
    ...
    description:
      "Fundamentals of physics, including motion, forces, and energy.",
    grade: 7,
  ...
  },
  {
    ...
    description:
      "Introduction to algebraic concepts, equations, and problem-solving.",
    grade: 8,
  ...
  },
  {
    ...
    description:
      "Basic chemistry, including elements, compounds, and reactions.",
    grade: 8,
